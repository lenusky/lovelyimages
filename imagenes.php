  ...
  <a class="grid-gallery__item" href="#">
        ...
        <img class="grid-gallery__image" src="images/image4.jpg">
                ...
                <table>
                 ...
                 <div class="wow-outer button-outer"> <tr>  <td><a class="button button-lg button-primary button-winona wow slideInUp" href="listadoimagenes.php" data-wow-delay=".3s">Ver Imágenes</a></td><td><a class="button button-lg button-primary button-winona wow slideInUp" href="formulario.html" data-wow-delay=".3s">Nueva imagen</a></td>
